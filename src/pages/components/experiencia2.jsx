                ...
                <div className={'col-lg-10 p-2'} >
                    <div className='row justify-content-center bg-white2 shadow round-s'>
                        ...
                        <div className='col-lg-12 p-1 dosis text-l text-bold text-black mt-0 mb-2 text-start'>
                            ...
                            <p className='ms-3 text-m text-600'>Durante mis estudios, desarrollé varios proyectos personales para automatizar procesos de un emprendimiento que creé, dedicado a la venta de repostería en línea.</p>
